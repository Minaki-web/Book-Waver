...
<body class="preload">
	...
	<main>
		...
		<div class="recommend_form_box">
			<form action="PostingChangeCheckController.php" method="post" class="recommend_form">
				<div class="column_flex">
					<section class="recommend_book_name recommend_form_section">
						...
						<input type="text" name="book_name" placeholder="例)こころ" value="<?php print(htmlentities($book_name, ENT_QUOTES));?>" maxlength="100" required>
					</section>
					<section class="recommend_book_author recommend_form_section">
						...
						<input type="text" name="author" placeholder="例)夏目漱石" value="<?php print(htmlentities($author, ENT_QUOTES));?>" maxlength="100" required>
					</section>
					<section class="recommend_price recommend_form_section">
						...
						<input type="text" name="price" placeholder="例)600" value="<?php print($price); ?>" required>
					</section>
					...
					<section class="q2 recommend_form_section">
						...
						<div class="q2-parts">
							<input type="radio" name="Q2" value="そう思う" id="agree" required>
					...
					<section class="q3 recommend_form_section">
						...
						<div class="q3_radio">
							<div class="q3_parts">
								<input type="radio" name="Q3" value="" id="none">
					...
					<section class="q4 recommend_form_section">
						...
						<div class="q4_parts">
							...
							<label for="4">4</label>
							<input type="radio" name="Q4" value="3" id="3" required>
							<label for="3">3</label>
					...
					<input type="submit" value="変更する" class="btn_type_submit recommend_form_btn">
				</div>
			</form>
		</div>
		<div class="formbox_below">
			<div class="formbox_below_inner">
				...
				<a href="CardInfoController.php?post_id=<?php print($post_id); ?>">前のページに戻る</a>
			</div>
			<div class="formbox_below_inner">
				<i class="far fa-arrow-alt-circle-right"></i>
