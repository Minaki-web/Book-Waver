...
<head>
  ...
  <title>パスワード変更画面 | Book Waver</title>
...
<body class="preload">
  ...
  <main>
    ...
    <form action="PasswordChangedController.php" method="post" class="formbox password_form">
      <div class="password_area">
        <input type="password" name="before_pwd" placeholder="変更前パスワード(半角英数)" autocomplete="off" required>
        <span class="field-icon">
          <i toggle="password-field" class="fas fa-eye toggle-password"></i>
        </span>
      </div>
      <div class="password_area">
        <input type="password" name="after_pwd" placeholder="変更後パスワード(半角英数30文字まで)" autocomplete="off" required>
        <span class="field-icon">
          <i toggle="password-field" class="fas fa-eye toggle-password"></i>
        </span>
      </div>
      <input type="submit" value="変更する" class="btn_type_submit">
    </form>
