...
<body>
	...
	<main>
		...
		<form action="PostingDeletedController.php" method="post" class="formbox delete_form">
			<p class="red_txt">投稿を削除します。<br>よろしいですか？</p>
			<p>本の名前：<br><span><?php print($book_name); ?></span></p>
			...
			<input type="submit" value="削除する" class="btn_type_submit">
		</form>
